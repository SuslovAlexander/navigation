...
export const LIST_ITEMS: IListItem[] = [
    {id: 1, text: "Продукты", selected: true, name: "products", url: <Products/>},
    {id: 2, text: "Пользователи", selected: false, name: "users", url: <Users/>},
    {id: 3, text: "Категории", selected: false, name: "categories", url: <Categories/>},
    {id: 4, text: "Города", selected: false, name: "cities", url: <Cities/>},
    {id: 5, text: "Бренды", selected: false, name: "brands", url: <Brands/>},
    {id: 6, text: "Протоколы", selected: false, name: "protocols", url: <Protocols/>},
    {id: 7, text: "Заказы", selected: false, name: "orders", url: <Orders/>},
    {id: 8, text: "Баннеры", selected: false, name: "banners", url: <Banners/>},
    {id: 9, text: "Семинары", selected: false, name: "seminars", url: <Seminars/>},
